...
#                                                           #
#  8.- DESCARGA E INSTALA MI TRADUCCION+MOD PARA OPENMSX    #
#                                                           #
#  9.- INSTALA LIBRERIAS LOCALES MODERNAS (LINUX LTS VIEJOS)# 
#                                                           #
#  0.- SOPORTA FEDORA Y MINT/UBUNTU/DEBIAN LTS x64 y ARM    #
#                                                           #
#                                                           #
# AUTORES:                                                  #
# ========                                                  #
...
OPTIONS=(1 "Instalar las dependencias necesarias para compilar y ejecutar"
         ...
         5 "Instalar traducción/mod de DrWh0 (para el usuario actual)"
...
case $CHOICE in
        ...
        4)  
            ...
            ;;
        5)
            # INSTALAR TRADUCCIÓN/MOD DE DRWH0 (AMBAS VERSIONES)
			...
			dialog --title "Paquete de traducción a español (ESC para cancelar)" \
			--backtitle "Parche adicional de traducción y mejoras de DrWh0" \
            --yesno '¿Instalas sobre una versión openMSX TSX Advanced?' 5 60
            ...
            1) 
               rm -Rf ~/.openMSX/share/scripts/*.*
               (pv -n script-normal.tar.gz | tar xzf - -C ~/.openMSX) 2>&1 | dialog --gauge "Descomprimiendo personalizaciones..." 6 50
               dialog --infobox "Personalización finalizada" 3 30 ; sleep 2
               ;;
            255) 
               dialog --infobox "Volviendo al menú principal........." 3 43 ; sleep 2
